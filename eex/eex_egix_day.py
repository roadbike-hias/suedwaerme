...
# Hardcoded variables
chartstartdate = "2025/04/29"
chartstopdate = "2025/06/30"
filename = os.path.join(os.path.dirname(__file__), "egix_day.csv")
...
if response.status_code == 200:
    ...
    with open(filename, "w", newline="", encoding="utf-8") as f:
        ...
        # Write the header
        writer.writerow(["EGIX Day", "Trading Day"])
        # Write the data
        writer.writerows(formatted_data)
    
    print("Data saved to egix_day.csv")
else:
